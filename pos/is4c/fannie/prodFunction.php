...
$dbProd = mysql_connect('localhost','root');
mysql_select_db('is4c_op',$dbProd);
...
function itemParse($upc){
    ...
    if($num == 0){
		...
		echo "<a href='auto_itemMaint.php'><font size='-1'>cancel</font></a>";
		...
		echo "<td><b>Price</b></td><td>$<input type=text name=price size=6></td></tr></table></div><div id='box'>";
        ...
        moreItems($upc);
			for($i=0;$i < $num;$i++){
	    		...
	    		$upc = $rowItem['upc'];
	    		echo "<a href='auto_itemMaint.php?upc=$upc'>" . $upc . " </a>- " . $rowItem['description'] . " -- $" .$rowItem['normal_price']. "<br>";
    		}
    }else{
        oneItem($upc);
        ...
        echo "<td>&nbsp;</td><td>&nbsp;</td></tr><tr><td><b>Description</b></td><td><input type=text size=30 value='$rowItem[1]' name=descript></td>";
        echo "<td><b>Price</b></td><td>$<input type=text value='$rowItem[2]' name=price size=10></td></tr>";
			if($rowItem[6] <> 0){
...
//						echo "</td><td>$likeCodeRow[2]</td><td><a href=./testSales.php?upc=$upc target=blank>Click for History</a></tr>";
				...
				echo "<td colspan='3' align='left'>Bottle deposit</td></tr>";
               	echo "<tr><td><input type='submit' name='submit' value='submit'>&nbsp;<a href='auto_itemMaint.php'><font size='-1'>cancel</font></a>";
...
//	echo "<font size='+2' color='red'>Creating New Item</font><a href='auto_itemMaint.php'>Cancel</a>";
}
