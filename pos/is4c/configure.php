...
echo "<body><basefont face=arial>";
echo "<form action=configure.php method=post>";
echo "<table border=0 cellpadding=0 cellspacing=0>";
echo "<tr><td height =40 width=100 valign=center bgcolor=#FFCC00 align=center>";
echo "<font face='arial' size=-1><B>I S 4 C</B></font>";
echo "</td><td><font face=arial size = 4><b>&nbsp;Lane Configuration</b></font></td><td>&nbsp;</td></tr>";
echo "<tr><td>&nbsp;</td></tr>";
...
echo "<td>&nbsp;</td><td><input type=submit value=submit name=submit></td></tr>";
echo "</table>";
echo "</form>";
echo "</body>";
